...
# Referrer route - accessible by both users and admins
...
def referrer():
    ...
    # Get all referrals for this user (admin sees all, regular sees own)
    if role == "admin":
        # For admin, show all referrals
        # We still want to display stats for context, so we get all rows
